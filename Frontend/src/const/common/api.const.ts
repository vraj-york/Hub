/**
 * API configuration and endpoint paths — aligned with `launchpad-frontend` data contracts
 * (see `launchpad-frontend/src/const/common/api.const.ts`).
 */
...
/**
 * API endpoints — same paths as the Launchpad web app for shared backend v15+.
 */
export const API_ENDPOINTS = {
	...
	corporations: {
		...
		companies: (corporationId: string) => `/corporations/${corporationId}/companies`,
		...
		companyByCompanyId: (companyId: string) => `/corporations/companies/${companyId}`,
		keyContacts: (companyId: string) => `/corporations/companies/${companyId}/key-contacts`,
		planSeats: (companyId: string) => `/corporations/companies/${companyId}/plan-seats`,
		companyConfiguration: (companyId: string) =>
			`/corporations/companies/${companyId}/configuration`,
		companyBrandLogo: (companyId: string) => `/corporations/companies/${companyId}/brand-logo`,
		...
		brandLogo: (corporationId: string) => `/corporations/${corporationId}/brand-logo`,
		keyContact: (corporationId: string) => `/corporations/${corporationId}/key-contact`,
		status: (corporationId: string) => `/corporations/${corporationId}/status`,
		reinstate: (corporationId: string) => `/corporations/${corporationId}/reinstate`,
	},
	pricing: {
		plans: "/pricing/plans",
	},
	...
	finance: {
		...
		invoicePdf: (invoiceId: string) => `/finance/invoices/${encodeURIComponent(invoiceId)}/pdf`,
		invoiceSend: (invoiceId: string) => `/finance/invoices/${encodeURIComponent(invoiceId)}/send`,
	},
	users: {
		root: "/users",
	},
